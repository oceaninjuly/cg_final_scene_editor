...
struct Axismodel{
    ...
    void Draw(glm::mat4 projection, glm::mat4 view) {
        ...
        shader.setVec2("axis_X", glm::normalize(glm::vec2(Axis_X)));
        shader.setVec2("axis_Y", glm::normalize(glm::vec2(Axis_Y)));
        shader.setVec2("axis_Z", glm::normalize(glm::vec2(Axis_Z)));
        glBindVertexArray(VAO);
